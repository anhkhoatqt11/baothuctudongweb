...
if (today.getDate()<10)
{
  url = "thiet-bi-ho-tro-giac-ngu.firebaseio.com/" + localStorage.getItem("iduser") + "/" + 0 + date;
}else{
  url = "thiet-bi-ho-tro-giac-ngu.firebaseio.com/" + localStorage.getItem("iduser") + "/" + date;
}
function refresh()
{
  if (today.getDate()<10)
...
var firebase = new Firebase("thiet-bi-ho-tro-giac-ngu.firebaseio.com/10032020");
...
function drawGraph(HeartRate){  
  ...
  options: {
    ...
    title:{
      display: true,
      text:'Biểu đồ nhịp tim ngày: ' + ng + ':' + th + ':' + nam,  
    },
